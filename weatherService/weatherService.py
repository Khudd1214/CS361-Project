...
weatherDict = {
    "oregon" : "Sun! Yes! To the water - oh wait, nvmd. Just started raining again. HOW? There aren't even clouds in the sky. Where is the rain coming from?",
    "california" : "The sounds of plants and animals dying as we go 6 months without rain... Ooh! Another earthquake.",
    ...
    "colorado" : "Nice and chill. If I lived in arizona, I would be running for the colorado hills.",
    "connecticut" : "If you like lightning and thunderstorms... what is wrong with you?",
    "delaware" : "Dull and Dry - just like the state.",
    "florida" : "Weather is the least of your problems - the thousands of drunk teenagers are a much bigger concern...",
    "georgia" : "At least it has water... Just be ready to dodge the sharks.",
    "idaho" : "Get ready for ice.",
    "illinois" : "A pleasant afternoon with sunshine and a gentle breeze... oh, nevermind. Now there's another thunderstorm",
...
def deleteSourceFile():
    ...
    return  #This return statement is implied, but I am including for the sake of clarity
...
#write the data in weather_response.csv
#if state is not None:
writeData(state)
#delete weather_request.csv
deleteSourceFile()
